...
# Clone este repositório
$ git clone git@github.com:WesleyDias28/conceitos-reactjs.git
...
> Veja o arquivo  [package.json](https://github.com/WesleyDias28/conceitos-reactjs/blob/master/package.json)
